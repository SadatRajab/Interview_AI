...
const translations = {
  en: {
    ...
    MENU_SCHEDULE: 'Interview Schedule',
    LOGOUT: 'Logout',
    ...
    NOTICE: 'Notice',
    SCHEDULE_TITLE: 'Interview Schedule Management',
    SCHEDULE_SUBTITLE: 'Define scheduled period and manual open/close controls for active interviews',
    SCHEDULE_START_DATE: 'Start Date',
    SCHEDULE_START_TIME: 'Start Time',
    SCHEDULE_END_DATE: 'End Date',
    SCHEDULE_END_TIME: 'End Time',
    SAVE_SCHEDULE: 'Save Settings',
    MANUAL_CONTROL: 'Interview Status Toggle',
    STATUS_OPEN: 'Open Interviews (Allow Candidate Access)',
    STATUS_CLOSED: 'Close Interviews (Deny Candidate Access)',
    DELETE_ALL_DUPLICATES: 'Delete All Duplicate Interviews',
    DELETE_ALL_DUPLICATES_CONFIRM: 'All duplicate interviews will be permanently deleted from the database, and this action cannot be undone.',
    NOT_STARTED_MSG: 'The interview period has not started yet.',
    ENDED_MSG: 'The interview period has ended.',
    MANUALLY_CLOSED_MSG: 'Interviews are currently closed.',
  ...
  ar: {
    ...
    MENU_SCHEDULE: 'مواعيد المقابلات',
    LOGOUT: 'تسجيل الخروج',
    DUPLICATE_BANNER_ALERT: 'حالة متقدم مكررة تم اكتشافها وتحتاج إلى مراجعة. اضغط هنا لفحصها.',
    NOTICE: 'تنبيه',
    SCHEDULE_TITLE: 'إدارة مواعيد المقابلات',
    SCHEDULE_SUBTITLE: 'تحديد فترة المقابلات والتحكم اليدوي في فتحها وإغلاقها للمتقدمين',
    SCHEDULE_START_DATE: 'تاريخ البدء',
    SCHEDULE_START_TIME: 'وقت البدء',
    SCHEDULE_END_DATE: 'تاريخ الانتهاء',
    SCHEDULE_END_TIME: 'وقت الانتهاء',
    SAVE_SCHEDULE: 'حفظ الإعدادات',
    MANUAL_CONTROL: 'حالة المقابلات اليدوية',
    STATUS_OPEN: 'فتح المقابلات (السماح للمتقدمين بالدخول)',
    STATUS_CLOSED: 'إغلاق المقابلات (منع المتقدمين من الدخول)',
    DELETE_ALL_DUPLICATES: 'حذف كافة المقابلات المكررة',
    DELETE_ALL_DUPLICATES_CONFIRM: 'سيتم حذف جميع المقابلات المكررة بشكل نهائي من قاعدة البيانات، ولا يمكن التراجع عن هذا الإجراء.',
    NOT_STARTED_MSG: 'فترة المقابلة لم تبدأ بعد.',
    ENDED_MSG: 'انتهت فترة المقابلات.',
    MANUALLY_CLOSED_MSG: 'المقابلات مغلقة حالياً.',
